function eegplugin_infocluster(fig, try_strings, catch_strings)
...
structure.uilist = { { } ...
    {'style' 'pushbutton' 'string' 'InfoCluster (beta)' 'Callback' 'args = { STUDY ALLEEG}; STUDY = pop_std_infocluster(args{:}); clear args;' } { } { } };
